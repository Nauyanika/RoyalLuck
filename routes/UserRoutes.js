...
router.get('/AndarBaharGamePlayHistory',UsersController.AndarBaharGamePlayHistoryData)
router.get('/RoulletGamePlayHistory',UsersController.RoulletGamePlayHistoryData)
router.get('/FunTargetGamePlayHistory',UsersController.FunTargetGamePlayHistoryData)
router.get('/TripleChanceGamePlayHistory',UsersController.TripleChanceGamePlayHistoryData)
router.get('/SevenUpGamePlayHistory',UsersController.SevenUpGamePlayHistoryData)
